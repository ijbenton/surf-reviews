                      ...
                      >
                        ...
                        >
                          <Menu.Item>
                            {({ active }) => (
                              <li
                                className={`${styles['nav__profile-item']} ${
                                  active ? 'bg-gray-100' : ''
                                }`}
                              >
                ...
                {navigation.map((item) => (
                  <li key={item.name}>
                    <CustomLink
                      ...
                      activeClassName={styles['nav__link--active']}
                    >
                      <a className={styles['nav__link-mobile']}>{item.name}</a>
                    </CustomLink>
                  </li>
                ))}
              </ul>
              ...
              <div className={styles['nav__mobile-profile']}>
                <div className={styles['nav__mobile-account']}>
                  ...
                  <div className={styles['nav__mobile-account-details']}>
                    <h2 className='text-white'>Ian Benton</h2>
                    <span className='text-gray-500 text-xs'>
                      bentonian1@gmail.com
                    </span>
                  </div>
                </div>
                <CustomLink href='/account' activeClassName=''>
                  <a href='#' className='text-gray-500 text-normal py-2 block'>
                    Your Profile
                  </a>
                </CustomLink>
                <a href='#' className='text-gray-500 text-normal py-2 block'>
