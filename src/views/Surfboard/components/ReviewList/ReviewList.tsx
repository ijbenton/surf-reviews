        ...
        <div className={styles['review-card']} key={`review-${idx}`}>
          ...
          <div className='flex relative w-full border-b-2 border-gray-100 pb-4 mb-4'>
            ...
            <div className='ml-4 text-xs font-semibold'>
              <p className='mb-1'>Review by {review.user.name}</p>
              <p className='mb-1'>
                Age: {review.user.age} | Height: {review.user.height} | Weight:{' '}
                {review.user.weight} lbs
              </p>
              <p className='mb-1'>Skill: {review.user.skill}</p>
